...
const LevelScript level_bits_entry[] = {
	...
	AREA(1, bits_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 585, 5475, 8377, 3, 0, 0, (1 << 16), bhvBreakableBoxSmall),
		OBJECT(MODEL_BREAKABLE_BOX, -372, 5475, 8377, 3, 0, 0, 0x00000000, bhvBreakableBoxSmall),
		OBJECT(MODEL_BREAKABLE_BOX, 588, 6316, 9603, 3, 0, 0, (1 << 16), bhvBreakableBoxSmall),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 268, 7175, 10834, 3, 0, 0, (2 << 16), bhvBreakableBoxSmall),
		OBJECT(MODEL_BREAKABLE_BOX, 54, 7175, 10834, 3, 0, 0, (2 << 16), bhvBreakableBoxSmall),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 377, 6316, 9603, 3, 0, 0, (1 << 16), bhvBreakableBoxSmall),
		OBJECT(MODEL_BREAKABLE_BOX, -47, 6316, 9603, 3, 0, 0, 0x00000000, bhvBreakableBoxSmall),
		OBJECT(MODEL_BREAKABLE_BOX, -587, 5475, 8377, 3, 0, 0, (1 << 16), bhvBreakableBoxSmall),
