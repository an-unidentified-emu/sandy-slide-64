...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_THWOMP, -49, -4632, -12300, 0, 0, 0, 0x00000000, bhvThwompKing),
		OBJECT(MODEL_NONE, 0, 7568, 15630, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 7568, 15511),
