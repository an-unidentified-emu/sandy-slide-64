...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BREAKABLE_BOX,           spindel_geo),
...
const LevelScript script_func_global_2[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_THWOMP,                  thwomp_geo),
        LOAD_MODEL_FROM_GEO(MODEL_THWIMP,                  thwimp_geo),
    LOAD_MODEL_FROM_GEO(MODEL_NEW_THWOMP,              new_thwomp_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SPINDEL,             spindel_geo),
    LOAD_MODEL_FROM_GEO(MODEL_GRINDEL,             grindel_geo),
    RETURN(),
};
